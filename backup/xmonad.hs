...
--myLayoutHook = spacingRaw False (Border 8 8 8 8) True (Border 8 8 8 8) True
               ...
               $ mkToggle (NBFULL ?? NOBORDERS ?? EOT)
					$ smartBorders
               $ tiled ||| Grid ||| spiral (7/8) ||| ThreeColMid 1 (3/100) (1/2) ||| noBorders (fullscreenFull Full)
                    where
...
--    viewShift    = doF . liftM2 (.) W.greedyView W.shift
    myCFloats = ["Arandr", "Arcolinux-tweak-tool.py", "Arcolinux-welcome-app.py", "Galculator", "Oblogout", "feh", "mpv", "vlc", "lxappearance", "Nitrogen", "nomacs", "Viewnior", "Xfce4-appfinder", "Audacious", "Deadbeef"]
...
--  , ((modMask, xK_f), sendMessage $ Toggle NBFULL)
  , ((modMask, xK_f), sendMessage (Toggle NBFULL) >> sendMessage ToggleStruts)
